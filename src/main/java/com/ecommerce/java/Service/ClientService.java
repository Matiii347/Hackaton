...
import com.ecommerce.java.Email.EmailNotifications;
import com.ecommerce.java.Entity.Client;
import com.ecommerce.java.Entity.Photo;
import com.ecommerce.java.Entity.Rol;
...
public class ClientService implements UserDetailsService {
    ...
    public Client createClient(String name, String lastname, Long document, String phoneNumber, String address,
            String email, String password1, String password2, MultipartFile file) throws ErrorService, IOException {
    ...
    public Client editClient(String idClient, MultipartFile file, String name, String lastname, Long document,
            String phoneNumber, String address, String email, String password1, String password2) throws ErrorService, IOException {
