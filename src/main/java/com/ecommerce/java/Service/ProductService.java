...
public class ProductService {
    ...
    @Transactional
    public Product createProduct(MultipartFile file, String name, String type, Integer price,
            Integer stock) throws ErrorService, IOException {
    ...
    @Transactional
    public Product editProduct(String idProduct, MultipartFile file, String name, String type, 
            Integer price, Integer stock) throws ErrorService, IOException {
